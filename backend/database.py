...
class AgentDiscoveryProfile(Base):
    ...
    evaluation_snapshot = Column(JSON, nullable=False, default=dict)
...
class Evaluation(Base):
    ...
    judge_scores = Column(JSON, nullable=False)
    judge_metadata = Column(JSON, nullable=False, default=dict)
...
class AgentTrace(Base):
    ...
    trace_metadata = Column(JSON, nullable=False, default=dict)
    created_at = Column(DateTime, default=datetime.utcnow)
