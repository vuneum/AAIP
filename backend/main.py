...
# CORS configuration
allowed_origins_str = os.getenv("AAIP_ALLOWED_ORIGINS", "").strip()
if allowed_origins_str == "*":
    allowed_origins = ["*"]
    logging.getLogger("uvicorn").warning(
        "AAIP_ALLOWED_ORIGINS is set to '*' – allowing any origin (insecure). "
    ...
    logging.getLogger("uvicorn").warning(
        "AAIP_ALLOWED_ORIGINS not set, defaulting to %s. "
        "In production, set AAIP_ALLOWED_ORIGINS to a restricted list of trusted origins.",
        allowed_origins
    )
