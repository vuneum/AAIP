...
async def verify_payment(
    ...
    async with trace_span_async(
        ...
        if not is_valid_hash:
            span.set_attribute("validation_result", "invalid_hash")
            span.set_status("error", "Invalid transaction hash format")
        ...
        span.set_attribute("validation_result", "verified")
        span.set_attribute("payment_id", payment_id)
        span.set_attribute("amount", "0.0020")
        span.set_attribute("currency", "USDC")
