...
# Import from SDK package using full path
from sdk.python.aaip import AAIPClient, AsyncAAIPClient, AgentManifest, ProofOfExecution, PoETrace, PoETraceStep
...
class TestTrackToolDecorator:
    def test_sync_decorator(self):
        from sdk.python.aaip import track_tool
        with ProofOfExecution("t-001", "co/agent/abc") as poe:
...
class TestAAIPClient:
    def test_client_init_from_env(self, monkeypatch):
        ...
        from sdk.python.aaip.client import AAIPClient
        client = AAIPClient()
        assert client.api_key == "test-key-123"

    def test_client_headers_include_auth(self):
        from sdk.python.aaip.client import _BaseClient
...
class TestLangChainAdapter:
    def test_register_langchain_agent(self):
        from sdk.python.aaip.adapters.langchain import register_langchain_agent
        from sdk.python.aaip import AAIPClient
...
class TestCrewAIAdapter:
    def test_register_crew(self):
        from sdk.python.aaip.adapters.crewai import register_crew
        from sdk.python.aaip import AAIPClient
